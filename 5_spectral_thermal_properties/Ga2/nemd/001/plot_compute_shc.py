...
savefig('compute.png', dpi=300, bbox_inches='tight')
...
ylim([-1, 1])
gca().set_yticks(linspace(-1,1,11))
ylabel('K (eV/ps)')
...
xlim([0, 23])
gca().set_xticks(linspace(0,22,6))
ylim([0, 0.05])
gca().set_yticks(linspace(0,0.05,5))
